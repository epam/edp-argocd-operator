...
func (o *ProjectServiceListOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/projects][%d] projectServiceListOK  %+v", 200, o.Payload)
}
func (o *ProjectServiceListOK) GetPayload() *models.V1alpha1AppProjectList {
	return o.Payload
}
...
func (o *ProjectServiceListDefault) Error() string {
	return fmt.Sprintf("[GET /api/v1/projects][%d] ProjectService_List default  %+v", o._statusCode, o.Payload)
}
func (o *ProjectServiceListDefault) GetPayload() *models.RuntimeError {
	return o.Payload
}
