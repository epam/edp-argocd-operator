...
func (o *ProjectServiceDeleteTokenParams) WithIat(iat int64) *ProjectServiceDeleteTokenParams {
	o.SetIat(iat)
	return o
}

// SetIat adds the iat to the project service delete token params
func (o *ProjectServiceDeleteTokenParams) SetIat(iat int64) {
	o.Iat = iat
}
...
func (o *ProjectServiceDeleteTokenParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param iat
	if err := r.SetPathParam("iat", swag.FormatInt64(o.Iat)); err != nil {
		return err
	}
