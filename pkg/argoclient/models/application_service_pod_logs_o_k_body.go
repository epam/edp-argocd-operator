...
func (m *ApplicationServicePodLogsOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApplicationServicePodLogsOKBody) validateError(formats strfmt.Registry) error {
...
func (m *ApplicationServicePodLogsOKBody) validateResult(formats strfmt.Registry) error {
...
func (m *ApplicationServicePodLogsOKBody) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ApplicationServicePodLogsOKBody) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
