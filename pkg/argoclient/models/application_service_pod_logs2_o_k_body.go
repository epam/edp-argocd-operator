...
func (m *ApplicationServicePodLogs2OKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApplicationServicePodLogs2OKBody) validateError(formats strfmt.Registry) error {
...
func (m *ApplicationServicePodLogs2OKBody) validateResult(formats strfmt.Registry) error {
...
func (m *ApplicationServicePodLogs2OKBody) contextValidateError(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ApplicationServicePodLogs2OKBody) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
